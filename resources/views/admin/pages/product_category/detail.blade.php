    ...
    <form role="form" method="post" action="{{ route('admin.product_category.update',['id'=>$data->id]) }}">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control"  placeholder="Enter name" value="{{ $data->name }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="slug" name="slug" class="form-control" placeholder="Enter password" value="{{ $data->slug }}">
            </div>
